                        ...
                        children: [
                              ...
                              children: [
                                ...
                                Row(
                                  ...
                                  children: [
                                    ...
                                    Expanded(
                                        child: Text(
                                            ' ${orderModel.billingAddressData != null ? orderModel.billingAddressData.address : orderModel.billingAddress ?? ''}',
                                            maxLines: 3,
                          ...
                          Padding(
                            padding:
                                EdgeInsets.all(Dimensions.MARGIN_SIZE_SMALL),
                            child: Text(
                                '${getTranslated('order_note', context)} : ${orderModel.orderNote != null ? orderModel.orderNote ?? '' : ""}',
                                style: titilliumRegular),
                          ),
