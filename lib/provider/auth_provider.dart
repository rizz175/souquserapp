...
import 'package:flutter_sixvalley_ecommerce/service_app/app/modules/auth/controllers/auth_controller.dart';
...
class AuthProvider with ChangeNotifier {
    ...
    if (apiResponse.response != null &&
      ...
      if (token != null) {
        ...
        await Get.find<AuthController>()
            .login(User.fromJson(apiResponse.response.data[1]));
      }
  ...
  Future<ResponseModel> verifyPhone(String phone, String token) async {
    ...
    if (apiResponse.response != null &&
        apiResponse.response.statusCode == 200) {
      responseModel =
          ResponseModel(apiResponse.response.data[0]["message"], true);
    } else {
      String errorMessage;
      if (apiResponse.error is String) {
        print(apiResponse.error.toString());
