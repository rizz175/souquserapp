...
class MessagesController extends GetxController {
  ...
  void onInit() async {
    ...
    if (!isDone.value) {
      ...
      // await createMessage(new Message([_authService.user.value],
      //     id: UniqueKey().toString(), name: 'Appliance Repair Company'));
      // await createMessage(new Message([_authService.user.value],
      //     id: UniqueKey().toString(), name: 'Shifting Home'));
      // await createMessage(new Message([_authService.user.value],
      //     id: UniqueKey().toString(), name: 'Pet Car Company'));
    }
  }
