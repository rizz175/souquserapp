        ...
        appBar: AppBar(
          ...
          title: Obx(() {
            return Text(
              ...
              maxLines: 1,
              style:
                  Get.textTheme.headline6.merge(TextStyle(letterSpacing: 1.3)),
            );
          }),
        ),
        body: Column(
          ...
          children: <Widget>[
            ...
            Container(
              decoration: BoxDecoration(
                color: Get.find<SettingsService>().getDarkTheme().primaryColor,
                boxShadow: [
                  BoxShadow(
                    ...
                    children: [
                      ...
                      IconButton(
                        ...
                        icon: Icon(
                          ...
                          color: Get.find<SettingsService>()
                              .getDarkTheme()
                              .colorScheme
                              .secondary,
                          size: 30,
                    ...
                    child: TextField(
                      ...
                      decoration: InputDecoration(
                        ...
                        suffixIcon: IconButton(
                          padding:
                              EdgeInsetsDirectional.only(end: 20, start: 10),
                          onPressed: () {
